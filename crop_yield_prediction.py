...
Original file is located at
    https://colab.research.google.com/drive/17B_mixhC1NSeq8ba1UcuRm5QnbSSHnAZ
...
class CYPTrainTestSplitter:
  ...
  def customKFoldValidationSplit(self, Y_train_full, num_folds, log_fh=None):
    ...
    num_years = len(all_years)
    num_test_years = 1
    # we slide (num_folds - 1) times
    num_train_years = num_years - num_test_years - (num_folds - 1)
...
def main():
  ...
  parser = argparse.ArgumentParser(prog='crop_yield_prediction.py')
